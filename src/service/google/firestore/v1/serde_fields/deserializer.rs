...
impl serde_properties::LatLngTrait for crate::proto::google::r#type::LatLng {
...
impl serde_properties::MapValueTrait<Value> for MapValue {
...
impl serde_properties::ValueTrait for Value {
    ...
    fn new(value_type: serde_properties::ValueType<Self>) -> Self {
        let value_type = match value_type {
            ...
            serde_properties::ValueType::BytesValue(value) => ValueType::BytesValue(value),
            serde_properties::ValueType::ReferenceValue(value) => ValueType::ReferenceValue(value),
            ...
            serde_properties::ValueType::MapValue(value) => ValueType::MapValue(value),
            serde_properties::ValueType::KeyValue(_) => common_panic!(),
        };
        Value {
    ...
    fn into_value_type(self) -> Option<serde_properties::ValueType<Self>> {
        self.value_type.map(|value_type| match value_type {
            ...
            ValueType::BytesValue(value) => serde_properties::ValueType::BytesValue(value),
            ValueType::ReferenceValue(value) => serde_properties::ValueType::ReferenceValue(value),
            ...
            ValueType::MapValue(value) => serde_properties::ValueType::MapValue(value),
        })
    }
    ...
    fn get_value_type<'s>(&'s self) -> Option<serde_properties::ValueTypeRef<Self>> {
        self.value_type.as_ref().map(|value_type| match value_type {
            ...
            ValueType::BytesValue(value) => serde_properties::ValueTypeRef::BytesValue(value),
            ValueType::ReferenceValue(value) => {
                serde_properties::ValueTypeRef::ReferenceValue(value)
            }
            ...
            ValueType::MapValue(value) => serde_properties::ValueTypeRef::MapValue(value),
        })
    }
}
